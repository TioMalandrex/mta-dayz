...
login.label[1] = guiCreateLabel(16, 25, 211, 15, "Nome de usuário:", false, login.window[1])
...
register.label[1] = guiCreateLabel(16, 25, 211, 15, "Nome de usuário:", false, register.window[1])
...
register.label[4] = guiCreateLabel(16, 153, 211, 15, "Senha 2x:", false, register.window[1])
...
language.window[1] = guiCreateWindow(0, 0, 243, 75, "Escolher Idioma", false)
