...
function settings_gui()
    ...
    ucp.label[5] = guiCreateLabel(10, 35, 289, 15, "Total de zumbis mortos: N/D", false, ucp.tab[2])
    ucp.label[6] = guiCreateLabel(10, 60, 289, 15, "Total de tiros na cabeça: N/D", false, ucp.tab[2])
    ucp.label[7] = guiCreateLabel(10, 85, 289, 15, "Total de bandidos mortos: N/D", false, ucp.tab[2])
    ucp.label[8] = guiCreateLabel(10, 110, 289, 15, "Total de tiros disparados: N/D", false, ucp.tab[2])
    ucp.label[9] = guiCreateLabel(10, 135, 289, 15, "Total de mortes: N/D", false, ucp.tab[2])
    ...
    ucp.label[12] = guiCreateLabel(10, 201, 289, 15, "Entrou em: 21 Agosto, 2017.", false, ucp.tab[2])
    ...
    ucp.label[14] = guiCreateLabel(16, 58, 277, 15, "*por questões de segurança, você não pode mudar seu email.", false, ucp.tab[3])
    ...
    ucp.button[1] = guiCreateButton(181, 189, 112, 30, "Mudar Senha", false, ucp.tab[3])
...
setTimer(function()
    if (getElementData(localPlayer,"logedin")) then
        ...
        guiSetText(ucp.label[12],"Entrou em: "..time.monthday.." "..monthToName[time.month].." "..time.year);
    end
end,5000,0);
