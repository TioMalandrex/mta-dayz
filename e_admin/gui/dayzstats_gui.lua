function dayzStatsGui()
	...
	dayzStatsLabel = guiCreateLabel(10, 6, 250, 15, "DEFINIR STATS DAYZ", false, dayzStatsWindow)
	guiSetFont(dayzStatsLabel, "default-bold-small")
	guiLabelSetHorizontalAlign(dayzStatsLabel, "center", false)
	dayzHumanityLabel = guiCreateLabel(10, 27, 55, 25, "Humanidade", false, dayzStatsWindow)
	guiLabelSetVerticalAlign(dayzHumanityLabel, "center")
	dayzStatsZombieKillsLabel = guiCreateLabel(10, 56, 55, 25, "Mortes Zumbis", false, dayzStatsWindow)
	guiLabelSetVerticalAlign(dayzStatsZombieKillsLabel, "center")
	dayzStatsMurdersLabel = guiCreateLabel(10, 85, 55, 25, "Assassinatos", false, dayzStatsWindow)
	...
	dayzButtonHumanity = guiCreateButton(230, 27, 30, 25, "editar", false, dayzStatsWindow)
	addEventHandler("onClientGUIClick",dayzButtonHumanity,editHumanity,false)

	dayzButtonZombieKills = guiCreateButton(230, 56, 30, 25, "editar", false, dayzStatsWindow)
	addEventHandler("onClientGUIClick",dayzButtonZombieKills,editZombieKills,false)
	
	dayzButtonMurders = guiCreateButton(230, 85, 30, 25, "editar", false, dayzStatsWindow)
	addEventHandler("onClientGUIClick",dayzButtonMurders,editMurders,false)

	dayzButtonClose = guiCreateButton(96, 114, 77, 23, "fechar", false, dayzStatsWindow)
