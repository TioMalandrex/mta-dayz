function vehicleGui()
	...
	vehicleWindowButtonSpawn = guiCreateButton(7, 258, 102, 23, "criar veículo", false, vehicleWindow)
	vehicleWindowButtonClose = guiCreateButton(158, 258, 66, 24, "fechar", false, vehicleWindow)
	vehicleWindowGridlist = guiCreateGridList(7, 25, 217, 227, false, vehicleWindow)
	guiGridListAddColumn(vehicleWindowGridlist, "Veículos", 0.85)
	vehicleWindowLabel = guiCreateLabel(7, 5, 217, 15, "MENU DE CRIAÇÃO DE VEÍCULOS", false, vehicleWindow)
