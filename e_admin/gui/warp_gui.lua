function warpGui()
	...
	guiGridListAddColumn(warpWindowGridlist, "Jogadores", 0.9)
	guiGridListAddRow(warpWindowGridlist)   

	warpWindowButtonWarp = guiCreateButton(7, 213, 102, 25, "teletransportar", false, warpWindow)
	warpWindowButtonClose = guiCreateButton(119, 213, 102, 25, "fechar", false, warpWindow)
