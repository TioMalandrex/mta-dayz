function banGui()
    ...
    banWindowLabel = guiCreateLabel(10, 5, 215, 15, "INSIRA O MOTIVO DO BANIMENTO", false, banWindow)
    ...
    banWindowTypeLabel = guiCreateLabel(10, 5, 195, 15, "Tipo:", false, banWindowGridlistType)
    ...
    banWindowDurationLabel = guiCreateLabel(10, 5, 196, 15, "Duração:", false, banWindowGridlistDuration)
    guiSetFont(banWindowDurationLabel, "default-bold-small")
    banWindowDuration1hour = guiCreateRadioButton(14, 24, 192, 15, "1 hora", false, banWindowGridlistDuration)
    banWindowDuration1day = guiCreateRadioButton(14, 39, 192, 15, "1 dia", false, banWindowGridlistDuration)
    banWindowDuration1Week = guiCreateRadioButton(14, 54, 192, 15, "1 semana", false, banWindowGridlistDuration)
    guiRadioButtonSetSelected(banWindowDuration1hour, true)
    banWindowDurationPermanent = guiCreateRadioButton(14, 69, 192, 15, "Permanente", false, banWindowGridlistDuration)

    banWindowButtonBan = guiCreateButton(10, 218, 105, 25, "banir", false, banWindow)
    banWindowButtonClose = guiCreateButton(120, 218, 105, 25, "fechar", false, banWindow)
