function giveGui()
	...
	giveWindowCombobox = guiCreateComboBox(10, 10, 150, 180, "Escolher Categoria", false, giveWindow)
	guiComboBoxAddItem(giveWindowCombobox, "Armas")
	guiComboBoxAddItem(giveWindowCombobox, "Munição")
	guiComboBoxAddItem(giveWindowCombobox, "Comida")
	guiComboBoxAddItem(giveWindowCombobox, "Roupas")
	guiComboBoxAddItem(giveWindowCombobox, "Mochilas")
	guiComboBoxAddItem(giveWindowCombobox, "Peças de Veículo")
	guiComboBoxAddItem(giveWindowCombobox, "Itens Médicos")
	guiComboBoxAddItem(giveWindowCombobox, "Ferramentas")
	--guiComboBoxAddItem(giveWindowCombobox, "Crafting Items")
	guiComboBoxAddItem(giveWindowCombobox, "Diversos")

	giveWindowLabel = guiCreateLabel(160, 12, 92, 15, "PAINEL DE DOAÇÃO", false, giveWindow)
	...
	guiGridListAddColumn(giveWindowGridlist, "Itens", 0.85)
	...
	giveWindowButtonGive = guiCreateButton(6, 270, 48, 24, "dar", false, giveWindow)
	giveWindowButtonGiveAll = guiCreateButton(60, 270, 56, 24, "dar tudo", false, giveWindow)

	giveWindowButtonClose = guiCreateButton(190, 270, 66, 24, "fechar", false, giveWindow)
