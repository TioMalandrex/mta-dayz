function muteGui()
	...
	muteWindowLabel = guiCreateLabel(10, 6, 215, 15, "INSIRA O MOTIVO DO SILENCIAMENTO", false, muteWindow)
	...
	mute5mins = guiCreateRadioButton(10, 7, 194, 15, "5 Minutos", false, muteGridlist)
	guiSetEnabled(mute5mins,false)
	mute10mins = guiCreateRadioButton(10, 22, 194, 15, "10 Minutos", false, muteGridlist)
	guiSetEnabled(mute10mins,false)
	mute20mins = guiCreateRadioButton(10, 37, 194, 15, "20 Minutos", false, muteGridlist)
	guiSetEnabled(mute20mins,false)
	muteUntilReconnect = guiCreateRadioButton(10, 57, 194, 15, "Até Reconectar", false, muteGridlist)
	guiRadioButtonSetSelected(muteUntilReconnect, true)

	muteButtonMute = guiCreateButton(10, 140, 102, 25, "silenciar", false, muteWindow)
	muteButtonClose = guiCreateButton(122, 140, 102, 25, "fechar", false, muteWindow)
