function kickGui()
	...
	kwLabel = guiCreateLabel(10, 7, 215, 15, "INSIRA O MOTIVO DA EXPULSÃO", false, kickWindow)
	guiSetFont(kwLabel, "default-bold-small")
	guiLabelSetHorizontalAlign(kwLabel, "center", false)
	kwButton = guiCreateButton(10, 58, 102, 25, "expulsar", false, kickWindow)

	kwButtonClose = guiCreateButton(122, 58, 102, 25, "fechar", false, kickWindow)
